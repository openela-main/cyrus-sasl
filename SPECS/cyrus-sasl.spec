...
Patch504: cyrus-sasl-2.1.27-remove-debug-log-mech-free.patch
...
* Wed Apr 01 2026 Rob Crittenden <rcritten@redhat.com> - 2.1.28-30
- Remove the sanity-ldapdb-plugin test

* Thu Jul 03 2025 Rob Crittenden <rcritten@redhat.com> - 2.1.28-29
- Add missing definition for gdbm_db_file

* Mon Mar 31 2025 Rob Crittenden <rcritten@redhat.com> - 2.1.28-28
- Remove debug log spam in digestmd5 plugin

* Wed Dec 04 2024 Rob Crittenden <rcritten@redhat.com> - 2.1.28-27
- Drop the baseos-ci gating test. It is deprecated

* Mon Dec 02 2024 Rob Crittenden <rcritten@redhat.com> - 2.1.28-26
- Switch gating to depend on idm-ci.brew-build.tier1.functional

* Tue Oct 29 2024 Troy Dawson <tdawson@redhat.com> - 2.1.28-25
- Bump release for October 2024 mass rebuild:

* Wed Jun 26 2024 Sudhir Menon <sumenon@redhat.com> - 2.1.28-24
- Added gating.yaml for cyrus-sasl

* Mon Jun 24 2024 Troy Dawson <tdawson@redhat.com> - 2.1.28-23
